...
export default React.memo(function Gallery({ setShift }) {
    ...
    const [imgSrcs, setImgSrcs] = useState([
        ...
        [oldPortfolio, 'http://maverickoleson.com/', 'https://github.com/Moleso587587/Portfolio-Website', "This is my old portfolio website. I was pretty happy with the aesthetic, although I didn't like the font, and I was especially proud of the spinning 3d pyramid I made using 3d css."],
